    ...
    <div class="flex h-full">
        ...
        <div class="w-1/2 bg-[#EAEAEA] flex items-center justify-center">
            <div class="w-md space-y-8">
                ...
                <!-- Form -->
                <form class="space-y-8 text-[#313038]" method="POST" action="./Process/Register.Process.php">

                    <!-- Full Name -->
                    <div class="relative mt-6">
                        <label class="absolute -top-2 left-3 text-sm font-bold px-1 bg-[#EAEAEA]">Full Name</label>
                        <input required name="Register_Full_Name" type="text"
                    ...
                    <!-- Re-enter -->
                    <div class="relative mt-6">
                        <label class="absolute -top-2 left-3 text-sm font-bold px-1 bg-[#EAEAEA]">Re-enter</label>
                        <input required name="Register_Re_Password" type="password"
                            class="w-full mt-1 border border-[#313038] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                    </div>
                ...
                <div class="flex items-center">
                    ...
                    <span class="px-3 text-xs text-gray-500">Already have an account?</span>
                    <div class="flex-grow h-px bg-gray-300"></div>
                </div>

                <!-- Local Button -->
                <div class="text-center">
                    <a href="./Login.php" class="border border-gray-400 px-6 py-1 text-sm hover:bg-gray-200 transition cursor-pointer">
                        Login
                    </a>
                </div>
        ...
        <div class="w-1/2 bg-gray-800 flex items-center justify-center relative">
            ...
            <div class="flex items-center space-x-12">
                ...
                <img class="scale-70" src="Assets/Work.svg" alt="Login Illustration" class="w-64">
